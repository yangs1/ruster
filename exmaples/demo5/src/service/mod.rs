...
use crate::{pb::abi::{CommandResponse, CommandRequest, command_request::RequestData, Hget, Kvpair}, storage::Storage, error::KvError};
...
impl<Store: Storage> Service<Store> {
    pub fn new (store : Store) -> Self {
        Self { inner: Arc::new( ServiceInner {store: store}) }
    }
